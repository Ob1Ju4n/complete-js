...
1. Create variables for the heights and yearsOfBirth of two friends and assign them some values
...
3. Use a loop to fill the array with the yearsOfBirth of the persons
...
function printFullAge(years) {
    ...
    for (var i = 0; i < years.length; i++) {
        yearsOfBirth[i] = 2016 - years[i];
    }

    for (i = 0; i < yearsOfBirth.length; i++) {
        if (yearsOfBirth[i] >= 18) {
            console.log('Person ' + (i + 1) + ' is ' + yearsOfBirth[i] + ' years old, and is of full age.');
            fullAges.push(true);
        } else {
            console.log('Person ' + (i + 1) + ' is ' + yearsOfBirth[i] + ' years old, and is NOT of full age.');
            fullAges.push(false);
        }
    }
